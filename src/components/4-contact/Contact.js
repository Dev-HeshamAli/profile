...
export default function Contact() {
  ...
  const [succrssSnackbar, setSuccrssSnackbar] = useState(true);
  ...
  const handleFakeSubmit = (values, { setSubmitting, resetForm }) => {
      ...
      <Grid container spacing={2} alignItems={"center"}>
        <Grid item xs={12} lg={7} sm={displayAnimation ? 7 : 12}>
          ...
          <Formik
            ...
            onSubmit={handleFakeSubmit} // Fake submit function for design
          >
